...
function App() {
  ...
  return (
    ...
    <footer>
      ...
      <a target='_blank' href='https://repository.zohocorpcloud.in/zohocorp/user/Priyazoho-rep_002#/repositories'><Text><img src='/repository.ico'/> Zoho Repository Profile</Text></a>
    </footer>
     </div>
  )
}
