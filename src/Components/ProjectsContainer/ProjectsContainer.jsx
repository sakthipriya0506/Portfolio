...
export default function ProjectsContainer() {
    const [projects, setProjects] = useState([
        ...
        {name: 'MurAI',image: '/codeLinter.png',link: 'https://github.com/Thanos1025/Code_Translator_Frontend/tree/PriyaBranch/public', languages: [{name: 'React JS'}, {name: 'CSS'}, {name: 'Java'}, {name: 'MySQL'}], description: 'A project which formats the code in accordance to the rules provided by the user.'},
